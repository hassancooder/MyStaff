  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-[60%] md:w=[75%] px-4 sm:px-6 lg:px-0 lg:w-[80%] xl:w-[65%] 3xl:w-[60%] mb-10 text-center mx-auto">
          <h3 className="text-xs md:text-sm font-semibold text-white break-words 3xl:text-2xl 3xl:mb-2">
            {title}
          </h3>
          <p className="text-xs md:text-xs text-blue-100 break-words 3xl:text-xl">
            {description}
          </p>
        </div>
      </div>

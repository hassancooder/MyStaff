      ...
      >
        <div className="w-full relative flex justify-center lg:justify-start 3xl:justify-center mb-4">
          <img
            ...
            alt="MyStaff App"
            className="object-contain w-[100px] sm:w-[140px] md:w-[180px] md:h-[120px] h-[100px] sm:h-[120px]  3xl:w-[200px] 3xl:h-[200px] lg:w-[140px] lg:h-[140px] 3xl:mb-0 mb-4"
          />
        </div>

        <div className=" px-5 xs:w-[47vw] sm:w-full sm:px-6 md:h-[20vh] mb-10 3xl:px-6 3xl:w-[20vw]   3xl:p-5  text-center">
          <h3 className="text-sm md:text-md font-semibold text-white break-words  3xl:text-3xl 3xl:mb-2">
            {title}
          </h3>
          <p className="text-xs md:text-sm text-blue-100 break-words 3xl:text-2xl">
            {description}
          </p>
        </div>
      </div>

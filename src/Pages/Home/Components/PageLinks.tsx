...
const PageLinks: React.FC = () => {
  return (
    <section className="relative w-full px-6 lg:px-20 mt-12 z-10">
      <div className="container w-full max-w-6xl mx-auto flex flex-col lg:flex-row items-center rounded-2xl justify-between lg:-mt-44 2xl:-mt-[22%]">
        ...
        {/* ===== RIGHT SIDE: BUTTONS ===== */}
        <div className="w-full max-w-md mt-11 lg:mt-0 z-30">
          <div className="lg:bg-white rounded-2xl lg:shadow-xl p-6 lg:px-12 flex flex-col ml-6 lg:ml-0 gap-4 lg:gap-6">
            {/* Button 1 - Healthcare */}
            <Link
              to="/healthcare"

    ...
    <section className="bg-white overflow-hidden -mt-20">
      <div className="w-full flex flex-col-reverse lg:flex-row items-stretch justify-between min-h-[80vh]">
        <div className="w-full lg:w-[70vw] flex flex-col justify-between">
          <div className="flex flex-col xl:py-20 xl:px-20 lg:ml-2 xl:ml-0 container mx-auto px-4 sm:px-6 lg:px-10 2xl:px-16 3xl:ml-7">
            <h2
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-20 mt-10 px-4 sm:px-10">
              {impacts.map((impact) => (
                <div
                  key={impact.id}
          ...
          <div
            className="bg-blue-600 text-white px-4 sm:px-10 py-4 mt-10"
            data-aos="fade-up"
          >

            ...
            return (
              <div key={feature.id} className=" flex flex-col w-full py-2">
                <div className=" relative w-full flex items-end ">
                  <img src={`./eduf${feature.id}.webp`} className="w-full" />
                  <h3 className="absolute text-white bottom-7 left-14 text-2xl lg:text-3xl 3xl:bottom-12 3xl:left-20 3xl:text-4xl">
                    {feature.title}
                  </h3>
                  {/* <img
                ...
                <p className="pl-14 text-sm text-blue-800 md:text-base lg:text-lg xl:text-xl 2xl:text-2xl">
                  {feature.description}
                </p>
              </div>
            );

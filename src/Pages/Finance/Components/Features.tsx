  ...
  const features = [
    {
      ...
      description: (
        <>
          to all type of data your bank and customers need (REMIT II, banking
          and/or country regulations, exchange and updates)
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      description: (
        <>
         Covers the full range of customer facing, and regulatory knowledge across the entire institution. 
        </>
      ),
    },
    {

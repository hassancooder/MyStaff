...
const Hero: React.FC = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: "url('./finance-hero-bg.webp')",
      }}
    >
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-normal mb-2 leading-tight text-white">
              {/* A critical tool to support  */}
              <span className="font-semibold">
                Your AI agent and compliance 
              </span>{isWideScreen ? <br /> : " "}
              manager to support your bank {isWideScreen ? <br /> : " "} and your customers
            </h2>

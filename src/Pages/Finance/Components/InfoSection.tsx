      ...
      <div className="relative flex flex-col md:flex-row gap-6 container mx-auto sm:px-6 lg:px-10">
        ...
        <div className="bg-black text-white py-6 px-8 rounded-2xl flex-1">
          <p className="text-sm leading-relaxed">
            All teams in private banking, asset management, relationship,
            trading, wealth are under constant pressure to stay compliant with
            complex regulations, but the documents they rely on are often
        ...
        <div className="absolute inset-0 flex items-center justify-center mt-0">
          <div className="w-16 h-16 bg-blue-600 border-[6px] border-[#DC9B16] rotate-90 md:rotate-0 rounded-full flex items-center justify-center mt-10 md:mt-0">
